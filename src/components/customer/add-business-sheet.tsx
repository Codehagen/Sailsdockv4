...
const formSchema = z.object({
  ...
  stage: z.nativeEnum(CustomerStage).default(CustomerStage.customer),
});
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await createBusiness({
        ...
        // Set email and phone empty but valid values since we're making them optional in the form
